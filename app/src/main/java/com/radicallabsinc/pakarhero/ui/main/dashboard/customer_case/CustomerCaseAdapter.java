...
public class CustomerCaseAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public CustomerCaseAdapter(List<CaseResponse.CaseData> caseList){
...
//        Log.e("dataIndex", String.valueOf(position)+ " " +String.valueOf(dataIndex)+ " " + String.valueOf(headerExpandTracker.get(dataIndex)));*/
    ...
    public class ViewHolder extends BaseViewHolder {
        ...
        public void onBind(int position){
            ...
            Picasso.with(itemView.getContext()).load(data.getCustomerImg()).transform(new CircleTransform()).into(ivPhoto);
